...
#    read -r GATEWAY_IP
    ...
    while [[ ! "$NEW_COMPUTER_NAME" =~ ^[0-9A-Z][0-9A-Z-]{1,63}$ ]]; do
...
echo " "
echo "Indtast hvor computeren hører til"
echo " "
echo "1: Bibliotekerne"
echo "3: Jobcenter"
echo "5: Generelt (kun til IT-service)"
echo "7: KioskPC"
read -r VALG
...
#        fi
#    fi
ADMIN_URL="https://os2borgerpc.sonderborg.dk:9990/site/"$SITE
